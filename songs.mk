...
$(MID_SUBDIR)/mus_vs_trainer.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G119 -V127 -P1
...
$(MID_SUBDIR)/mus_vs_elite_four.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G125 -V116 -P1
...
$(MID_SUBDIR)/se_sugi_dex_page.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G127 -v127 -P5

$(MID_SUBDIR)/se_sugi_dex_scroll.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G127 -v127 -P5
