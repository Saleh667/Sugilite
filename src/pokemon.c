...
#define SPECIES_TO_PHANTOS(name)      [SPECIES_##name - 1] = PHANTOS_DEX_##name
#define SPECIES_TO_NATIONAL(name)   [SPECIES_##name - 1] = NATIONAL_DEX_##name
#define PHANTOS_TO_NATIONAL(name)     [PHANTOS_DEX_##name - 1] = NATIONAL_DEX_##name

const u16 gSpeciesToHoennPokedexNum[NUM_SPECIES] = // Assigns all species to the Phantos Dex Index (Summary No. for Phantos Dex)
{
    SPECIES_TO_PHANTOS(CYBIO),
    SPECIES_TO_PHANTOS(PROBIO),
    SPECIES_TO_PHANTOS(DOMEBIO),
    SPECIES_TO_PHANTOS(IGNION),
    SPECIES_TO_PHANTOS(IGNICORUS),
    SPECIES_TO_PHANTOS(DRACOHOHO),
    SPECIES_TO_PHANTOS(JELLOSIS),
    SPECIES_TO_PHANTOS(LUQUODI),
    SPECIES_TO_PHANTOS(CNIDAROLT),
    SPECIES_TO_PHANTOS(DRAGBY),
    SPECIES_TO_PHANTOS(DRAGAFRAUD),
    SPECIES_TO_PHANTOS(WISBUG),
    SPECIES_TO_PHANTOS(SPOOCOON),
    SPECIES_TO_PHANTOS(HORRIMOTH),
    SPECIES_TO_PHANTOS(HOOTHOOT),
    SPECIES_TO_PHANTOS(NOCTOWL),
    SPECIES_TO_PHANTOS(GRAVEN),
    SPECIES_TO_PHANTOS(SHIRILL),
    SPECIES_TO_PHANTOS(GRIMIX),
    SPECIES_TO_PHANTOS(SORROGRIME),
    SPECIES_TO_PHANTOS(MORELULL),
    SPECIES_TO_PHANTOS(SHIINOTIC),
    SPECIES_TO_PHANTOS(BLIPBUG),
    SPECIES_TO_PHANTOS(DOTTLER),
    SPECIES_TO_PHANTOS(ORBEETLE),
    SPECIES_TO_PHANTOS(PETILIL),
    SPECIES_TO_PHANTOS(LILLIGANT),
    SPECIES_TO_PHANTOS(INDEEDEE),
    SPECIES_TO_PHANTOS(PANSAGE),
    SPECIES_TO_PHANTOS(SIMISAGE),
    SPECIES_TO_PHANTOS(PANPOUR),
    SPECIES_TO_PHANTOS(SIMIPOUR),
    SPECIES_TO_PHANTOS(PANSEAR),
    SPECIES_TO_PHANTOS(SIMISEAR),
    SPECIES_TO_PHANTOS(KYOOTEDI),
    SPECIES_TO_PHANTOS(JILTEDI),
    SPECIES_TO_PHANTOS(JUNTRICK),
    SPECIES_TO_PHANTOS(DUMPHILE),
    SPECIES_TO_PHANTOS(TOTEMI),
    SPECIES_TO_PHANTOS(TOMETIC),
    SPECIES_TO_PHANTOS(HOODLIN),
    SPECIES_TO_PHANTOS(CHENBALLIN),
    SPECIES_TO_PHANTOS(UNSHACKLIN),
    SPECIES_TO_PHANTOS(SLORMAG),
    SPECIES_TO_PHANTOS(CLASDRON),
    SPECIES_TO_PHANTOS(PLADYJACK),
    SPECIES_TO_PHANTOS(ZUBAT),
    SPECIES_TO_PHANTOS(GOLBAT),
    SPECIES_TO_PHANTOS(CROBAT),
};
...
{
    SPECIES_TO_NATIONAL(CYBIO),
    SPECIES_TO_NATIONAL(PROBIO),
    SPECIES_TO_NATIONAL(DOMEBIO),
    SPECIES_TO_NATIONAL(IGNION),
    SPECIES_TO_NATIONAL(IGNICORUS),
    SPECIES_TO_NATIONAL(DRACOHOHO),
    SPECIES_TO_NATIONAL(JELLOSIS),
    SPECIES_TO_NATIONAL(LUQUODI),
    SPECIES_TO_NATIONAL(CNIDAROLT),
    SPECIES_TO_NATIONAL(DRAGBY),
    SPECIES_TO_NATIONAL(DRAGAFRAUD),
    SPECIES_TO_NATIONAL(WISBUG),
    SPECIES_TO_NATIONAL(SPOOCOON),
    SPECIES_TO_NATIONAL(HORRIMOTH),
    SPECIES_TO_NATIONAL(HOOTHOOT),
    SPECIES_TO_NATIONAL(NOCTOWL),
    SPECIES_TO_NATIONAL(GRAVEN),
    SPECIES_TO_NATIONAL(SHIRILL),
    SPECIES_TO_NATIONAL(GRIMIX),
    SPECIES_TO_NATIONAL(SORROGRIME),
    ...
    SPECIES_TO_NATIONAL(KYOOTEDI),
    SPECIES_TO_NATIONAL(JILTEDI),
    SPECIES_TO_NATIONAL(JUNTRICK),
    SPECIES_TO_NATIONAL(DUMPHILE),
    SPECIES_TO_NATIONAL(TOTEMI),
    SPECIES_TO_NATIONAL(TOMETIC),
    SPECIES_TO_NATIONAL(HOODLIN),
    SPECIES_TO_NATIONAL(CHENBALLIN),
    SPECIES_TO_NATIONAL(UNSHACKLIN),
    SPECIES_TO_NATIONAL(SLORMAG),
    SPECIES_TO_NATIONAL(CLASDRON),
    SPECIES_TO_NATIONAL(PLADYJACK),
    SPECIES_TO_NATIONAL(ZUBAT),
    SPECIES_TO_NATIONAL(GOLBAT),
    SPECIES_TO_NATIONAL(CROBAT),
};

const u16 gHoennToNationalOrder[PHANTOS_DEX_COUNT] = // Assigns Phantos Dex Pokémon (Using National Dex Index)
{
    PHANTOS_TO_NATIONAL(CYBIO),
    PHANTOS_TO_NATIONAL(PROBIO),
    PHANTOS_TO_NATIONAL(DOMEBIO),
    PHANTOS_TO_NATIONAL(IGNION),
    PHANTOS_TO_NATIONAL(IGNICORUS),
    PHANTOS_TO_NATIONAL(DRACOHOHO),
    PHANTOS_TO_NATIONAL(JELLOSIS),
    PHANTOS_TO_NATIONAL(LUQUODI),
    PHANTOS_TO_NATIONAL(CNIDAROLT),
    PHANTOS_TO_NATIONAL(DRAGBY),
    PHANTOS_TO_NATIONAL(DRAGAFRAUD),
    PHANTOS_TO_NATIONAL(WISBUG),
    PHANTOS_TO_NATIONAL(SPOOCOON),
    PHANTOS_TO_NATIONAL(HORRIMOTH),
    PHANTOS_TO_NATIONAL(HOOTHOOT),
    PHANTOS_TO_NATIONAL(NOCTOWL),
    PHANTOS_TO_NATIONAL(GRAVEN),
    PHANTOS_TO_NATIONAL(SHIRILL),
    PHANTOS_TO_NATIONAL(GRIMIX),
    PHANTOS_TO_NATIONAL(SORROGRIME),
    PHANTOS_TO_NATIONAL(MORELULL),
    PHANTOS_TO_NATIONAL(SHIINOTIC),
    PHANTOS_TO_NATIONAL(BLIPBUG),
    PHANTOS_TO_NATIONAL(DOTTLER),
    PHANTOS_TO_NATIONAL(ORBEETLE),
    PHANTOS_TO_NATIONAL(PETILIL),
    PHANTOS_TO_NATIONAL(LILLIGANT),
    PHANTOS_TO_NATIONAL(INDEEDEE),
    PHANTOS_TO_NATIONAL(PANSAGE),
    PHANTOS_TO_NATIONAL(SIMISAGE),
    PHANTOS_TO_NATIONAL(PANPOUR),
    PHANTOS_TO_NATIONAL(SIMIPOUR),
    PHANTOS_TO_NATIONAL(PANSEAR),
    PHANTOS_TO_NATIONAL(SIMISEAR),
    PHANTOS_TO_NATIONAL(KYOOTEDI),
    PHANTOS_TO_NATIONAL(JILTEDI),
    PHANTOS_TO_NATIONAL(JUNTRICK),
    PHANTOS_TO_NATIONAL(DUMPHILE),
    PHANTOS_TO_NATIONAL(TOTEMI),
    PHANTOS_TO_NATIONAL(TOMETIC),
    PHANTOS_TO_NATIONAL(HOODLIN),
    PHANTOS_TO_NATIONAL(CHENBALLIN),
    PHANTOS_TO_NATIONAL(UNSHACKLIN),
    PHANTOS_TO_NATIONAL(SLORMAG),
    PHANTOS_TO_NATIONAL(CLASDRON),
    PHANTOS_TO_NATIONAL(PLADYJACK),
    PHANTOS_TO_NATIONAL(ZUBAT),
    PHANTOS_TO_NATIONAL(GOLBAT),
    PHANTOS_TO_NATIONAL(CROBAT),
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_CYBIO - 1] = 0x0b,
    [SPECIES_PROBIO - 1] = 0x17,
    [SPECIES_DOMEBIO - 1] = 0x1c,
    [SPECIES_IGNION - 1] = 0x48,
    [SPECIES_IGNICORUS - 1] = 0x17,
    [SPECIES_DRACOHOHO - 1] = 0x17,
    [SPECIES_JELLOSIS - 1] = 0x45,
    [SPECIES_LUQUODI - 1] = 0x45,
    [SPECIES_CNIDAROLT - 1] = 0x3a,
    [SPECIES_DRAGBY - 1] = 0x05,
    [SPECIES_DRAGAFRAUD - 1] = 0x49,
    [SPECIES_WISBUG - 1] = 0x0b,
    [SPECIES_SPOOCOON - 1] = 0x15,
    [SPECIES_HORRIMOTH - 1] = 0x17,
    [SPECIES_GRAVEN - 1] = 0x0d,
    [SPECIES_SHIRILL - 1] = 0x09,
    [SPECIES_GRIMIX - 1] = 0x01,
    [SPECIES_SORROGRIME - 1] = 0x10,
    [SPECIES_KYOOTEDI - 1] = 0x52,
    [SPECIES_JILTEDI - 1] = 0x00,
    [SPECIES_JUNTRICK - 1] = 0x32,
    [SPECIES_DUMPHILE - 1] = 0x19,
    [SPECIES_TOTEMI - 1] = 0x05,
    [SPECIES_TOMETIC - 1] = 0x10,
    [SPECIES_HOODLIN - 1] = 0x0b,
    [SPECIES_CHENBALLIN - 1] = 0x17,
    [SPECIES_UNSHACKLIN - 1] = 0x0f,
    [SPECIES_SLORMAG - 1] = 0x01,
    [SPECIES_CLASDRON - 1] = 0x17,
    [SPECIES_PLADYJACK - 1] = 0x49,
...
u16 NationalToHoennOrder(u16 nationalNum)
{
    ...
    while (hoennNum < (PHANTOS_DEX_COUNT - 1) && gHoennToNationalOrder[hoennNum] != nationalNum)
        hoennNum++;

    if (hoennNum >= PHANTOS_DEX_COUNT - 1)
        return 0;
...
{
    if (!hoennNum || hoennNum >= PHANTOS_DEX_COUNT)
        return 0;
...
{
    if (SpeciesToHoennPokedexNum(species) > PHANTOS_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
