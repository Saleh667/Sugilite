...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_CYBIO - 1]         = ANIM_SWING_CONCAVE,
    [SPECIES_PROBIO - 1]        = ANIM_V_STRETCH,
    [SPECIES_DOMEBIO - 1]       = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_IGNION - 1]        = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_IGNICORUS - 1]     = ANIM_V_STRETCH,
    [SPECIES_DRACOHOHO - 1]     = ANIM_V_STRETCH,
    [SPECIES_JELLOSIS - 1]      = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_LUQUODI - 1]       = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_CNIDAROLT - 1]     = ANIM_GROW_IN_STAGES,
    [SPECIES_DRAGBY - 1]        = ANIM_BOUNCE_ROTATE_TO_SIDES,
    [SPECIES_DRAGAFRAUD - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_WISBUG - 1]        = ANIM_SWING_CONCAVE,
    [SPECIES_SPOOCOON - 1]      = ANIM_GLOW_BLACK,
    [SPECIES_HORRIMOTH - 1]     = ANIM_V_STRETCH,
    [SPECIES_GRAVEN - 1]        = ANIM_SWING_CONVEX,
    [SPECIES_SHIRILL - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_GRIMIX - 1]        = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_SORROGRIME - 1]    = ANIM_V_SHAKE,
    [SPECIES_KYOOTEDI - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_JILTEDI - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_JUNTRICK - 1]      = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_DUMPHILE - 1]      = ANIM_V_SHAKE_TWICE,
    [SPECIES_TOTEMI - 1]        = ANIM_BOUNCE_ROTATE_TO_SIDES,
    [SPECIES_TOMETIC - 1]       = ANIM_V_SHAKE,
    [SPECIES_HOODLIN - 1]       = ANIM_SWING_CONCAVE,
    [SPECIES_CHENBALLIN - 1]    = ANIM_V_STRETCH,
    [SPECIES_UNSHACKLIN - 1]    = ANIM_H_SHAKE,
    [SPECIES_SLORMAG - 1]       = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_CLASDRON - 1]      = ANIM_V_STRETCH,
    [SPECIES_PLADYJACK - 1]     = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
