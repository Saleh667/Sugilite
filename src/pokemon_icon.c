...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_CYBIO] = gMonIcon_CYBIO,
    [SPECIES_PROBIO] = gMonIcon_PROBIO,
    [SPECIES_DOMEBIO] = gMonIcon_DOMEBIO,
    [SPECIES_IGNION] = gMonIcon_IGNION,
    [SPECIES_IGNICORUS] = gMonIcon_IGNICORUS,
    [SPECIES_DRACOHOHO] = gMonIcon_DRACOHOHO,
    [SPECIES_JELLOSIS] = gMonIcon_JELLOSIS,
    [SPECIES_LUQUODI] = gMonIcon_LUQUODI,
    [SPECIES_CNIDAROLT] = gMonIcon_CNIDAROLT,
    [SPECIES_DRAGBY] = gMonIcon_DRAGBY,
    [SPECIES_DRAGAFRAUD] = gMonIcon_DRAGAFRAUD,
    [SPECIES_WISBUG] = gMonIcon_WISBUG,
    [SPECIES_SPOOCOON] = gMonIcon_SPOOCOON,
    [SPECIES_HORRIMOTH] = gMonIcon_HORRIMOTH,
    [SPECIES_GRAVEN] = gMonIcon_GRAVEN,
    [SPECIES_SHIRILL] = gMonIcon_SHIRILL,
    [SPECIES_GRIMIX] = gMonIcon_GRIMIX,
    [SPECIES_SORROGRIME] = gMonIcon_SORROGRIME,
    [SPECIES_KYOOTEDI] = gMonIcon_KYOOTEDI,
    [SPECIES_JILTEDI] = gMonIcon_JILTEDI,
    [SPECIES_JUNTRICK] = gMonIcon_JUNTRICK,
    [SPECIES_DUMPHILE] = gMonIcon_DUMPHILE,
    [SPECIES_TOTEMI] = gMonIcon_TOTEMI,
    [SPECIES_TOMETIC] = gMonIcon_TOMETIC,
    [SPECIES_HOODLIN] = gMonIcon_HOODLIN,
    [SPECIES_CHENBALLIN] = gMonIcon_CHENBALLIN,
    [SPECIES_UNSHACKLIN] = gMonIcon_UNSHACKLIN,
    [SPECIES_SLORMAG] = gMonIcon_SLORMAG,
    [SPECIES_CLASDRON] = gMonIcon_CLASDRON,
    [SPECIES_PLADYJACK] = gMonIcon_PLADYJACK,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_TOMETIC] = 0,
    [SPECIES_HOODLIN] = 0,
    [SPECIES_CHENBALLIN] = 0,
    [SPECIES_UNSHACKLIN] = 0,
    [SPECIES_SLORMAG] = 0,
    [SPECIES_CLASDRON] = 0,
    [SPECIES_PLADYJACK] = 0,
