...
static const u16 sPokedexAreaMap_Pal[] = INCBIN_U16("graphics/pokenav/region_map.gbapal");
static const u32 sPokedexAreaMap_Gfx[] = INCBIN_U32("graphics/pokenav/dex_region_map.8bpp.lz");
static const u32 sPokedexAreaMap_Tilemap[] = INCBIN_U32("graphics/pokenav/dex_region_map.bin.lz");
