...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_CYBIO] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_PROBIO] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DOMEBIO] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_IGNION] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_IGNICORUS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_DRACOHOHO] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JELLOSIS] = BACK_ANIM_H_SLIDE,
    [SPECIES_LUQUODI] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_CNIDAROLT] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_DRAGBY] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_DRAGAFRAUD] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WISBUG] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_SPOOCOON] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_HORRIMOTH] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_GRAVEN] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SHIRILL] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_GRIMIX] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_SORROGRIME] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_KYOOTEDI] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_JILTEDI] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_JUNTRICK] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DUMPHILE] = BACK_ANIM_GROW_2,
    [SPECIES_TOTEMI] = BACK_ANIM_V_SHAKE_WITH_PAUSE,
    [SPECIES_TOMETIC] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_HOODLIN] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CHENBALLIN] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_UNSHACKLIN] = BACK_ANIM_V_SHAKE_WITH_PAUSE,
    [SPECIES_SLORMAG] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_CLASDRON] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_PLADYJACK] = BACK_ANIM_V_SHAKE_WITH_PAUSE,
};
