...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_CYBIO]      = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_PROBIO]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DOMEBIO]    = BACK_ANIM_V_SHAKE,
    [SPECIES_IGNION]     = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_IGNICORUS]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_DRACOHOHO]  = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_JELLOSIS]   = BACK_ANIM_H_SLIDE,
    [SPECIES_LUQUODI]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CNIDAROLT]  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_DRAGBY]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_DRAGAFRAUD] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WISBUG]     = BACK_ANIM_V_STRETCH,
    [SPECIES_SPOOCOON]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_HORRIMOTH]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_GRAVEN]     = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SHIRILL]    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_GRIMIX]     = BACK_ANIM_V_STRETCH,
    [SPECIES_SORROGRIME] = BACK_ANIM_H_STRETCH,
    [SPECIES_KYOOTEDI]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_JILTEDI]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_JUNTRICK]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DUMPHILE]   = BACK_ANIM_GROW_STUTTER,
    [SPECIES_TOTEMI]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_TOMETIC]    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_HOODLIN]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CHENBALLIN] = BACK_ANIM_H_SHAKE,
    [SPECIES_UNSHACKLIN] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SLORMAG]    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_CLASDRON]   = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_PLADYJACK]  = BACK_ANIM_V_SHAKE_LOW,
};
