...
static void PCTurnOnEffect_1(s16 isPcTurnedOn, s8 dx, s8 dy)
{
    ...
    if (isPcTurnedOn)
    {
        ...
        {
            tileId = METATILE_Indoors_BrendanPC_Off;
        }
        else if (gSpecialVar_0x8004 == PC_LOCATION_MAYS_HOUSE)
        {
            tileId = METATILE_Indoors_MayPC_Off;
        }
    }
    else
    {
        ...
        {
            tileId = METATILE_Indoors_BrendanPC_On;
        }
        else if (gSpecialVar_0x8004 == PC_LOCATION_MAYS_HOUSE)
        {
            tileId = METATILE_Indoors_MayPC_On;
        }
    }
...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], SPECIES_DRAGBY, 5, USE_RANDOM_IVS, FALSE, 0, OT_ID_PLAYER_ID, 0);
    monData = TRUE;
...
{
    if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(BATTLE_FRONTIER_BATTLE_TOWER_MULTI_PARTNER_ROOM) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(BATTLE_FRONTIER_BATTLE_TOWER_MULTI_PARTNER_ROOM) &&
