const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_CYBIO] = sCybioLevelUpLearnset,
    [SPECIES_PROBIO] = sProbioLevelUpLearnset,
    [SPECIES_DOMEBIO] = sDomebioLevelUpLearnset,
    [SPECIES_IGNION] = sIgnionLevelUpLearnset,
    [SPECIES_IGNICORUS] = sIgnicorusLevelUpLearnset,
    [SPECIES_DRACOHOHO] = sDracohohoLevelUpLearnset,
    [SPECIES_JELLOSIS] = sJellosisLevelUpLearnset,
    [SPECIES_LUQUODI] = sLuquodiLevelUpLearnset,
    [SPECIES_CNIDAROLT] = sCnidaroltLevelUpLearnset,
    [SPECIES_DRAGBY] = sDragbyLevelUpLearnset,
    [SPECIES_DRAGAFRAUD] = sDragafraudLevelUpLearnset,
    [SPECIES_WISBUG] = sWisbugLevelUpLearnset,
    [SPECIES_SPOOCOON] = sSpoocoonLevelUpLearnset,
    [SPECIES_HORRIMOTH] = sHorrimothLevelUpLearnset,
    [SPECIES_GRAVEN] = sGravenLevelUpLearnset,
    [SPECIES_SHIRILL] = sShirillLevelUpLearnset,
    [SPECIES_GRIMIX] = sGrimixLevelUpLearnset,
    [SPECIES_SORROGRIME] = sSorrogrimeLevelUpLearnset,
    [SPECIES_KYOOTEDI] = sKyootediLevelUpLearnset,
    [SPECIES_JILTEDI] = sJiltediLevelUpLearnset,
    [SPECIES_JUNTRICK] = sJuntrickLevelUpLearnset,
    [SPECIES_DUMPHILE] = sDumphileLevelUpLearnset,
    [SPECIES_TOTEMI] = sTotemiLevelUpLearnset,
    [SPECIES_TOMETIC] = sTometicLevelUpLearnset,
    [SPECIES_HOODLIN] = sHoodlinLevelUpLearnset,
    [SPECIES_CHENBALLIN] = sChenballinLevelUpLearnset,
    [SPECIES_UNSHACKLIN] = sUnshacklinLevelUpLearnset,
    [SPECIES_SLORMAG] = sSlormagLevelUpLearnset,
    [SPECIES_CLASDRON] = sClasdronLevelUpLearnset,
    [SPECIES_PLADYJACK] = sPladyjackLevelUpLearnset,
