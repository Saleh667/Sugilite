...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_BRENDANS_HOUSE_2F), 1, 6},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(LITTLEROOT_TOWN_MAYS_HOUSE_2F), MAP_NUM(LITTLEROOT_TOWN_MAYS_HOUSE_2F), 1, 6},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 7, 10},
    ...
    [HEAL_LOCATION_KUROSIBA_TOWN - 1] = {MAP_GROUP(KUROSIBA_TOWN), MAP_NUM(KUROSIBA_TOWN), 15, 7},
    [HEAL_LOCATION_ROUTE402B - 1] = {MAP_GROUP(ROUTE402B), MAP_NUM(ROUTE402B), 0, 0},
    [HEAL_LOCATION_THE_DARKWOODS - 1] = {MAP_GROUP(THE_DARKWOODS), MAP_NUM(THE_DARKWOODS), 0, 0},
};
