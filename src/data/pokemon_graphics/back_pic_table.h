const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(CYBIO, gMonBackPic_CYBIO),
    SPECIES_SPRITE(PROBIO, gMonBackPic_PROBIO),
    SPECIES_SPRITE(DOMEBIO, gMonBackPic_DOMEBIO),
    SPECIES_SPRITE(IGNION, gMonBackPic_IGNION),
    SPECIES_SPRITE(IGNICORUS, gMonBackPic_IGNICORUS),
    SPECIES_SPRITE(DRACOHOHO, gMonBackPic_DRACOHOHO),
    SPECIES_SPRITE(JELLOSIS, gMonBackPic_JELLOSIS),
    SPECIES_SPRITE(LUQUODI, gMonBackPic_LUQUODI),
    SPECIES_SPRITE(CNIDAROLT, gMonBackPic_CNIDAROLT),
    SPECIES_SPRITE(DRAGBY, gMonBackPic_DRAGBY),
    SPECIES_SPRITE(DRAGAFRAUD, gMonBackPic_DRAGAFRAUD),
    SPECIES_SPRITE(WISBUG, gMonBackPic_WISBUG),
    SPECIES_SPRITE(SPOOCOON, gMonBackPic_SPOOCOON),
    SPECIES_SPRITE(HORRIMOTH, gMonBackPic_HORRIMOTH),
    SPECIES_SPRITE(GRAVEN, gMonBackPic_GRAVEN),
    SPECIES_SPRITE(SHIRILL, gMonBackPic_SHIRILL),
    SPECIES_SPRITE(GRIMIX, gMonBackPic_GRIMIX),
    SPECIES_SPRITE(SORROGRIME, gMonBackPic_SORROGRIME),
    SPECIES_SPRITE(KYOOTEDI, gMonBackPic_KYOOTEDI),
    SPECIES_SPRITE(JILTEDI, gMonBackPic_JILTEDI),
    SPECIES_SPRITE(JUNTRICK, gMonBackPic_JUNTRICK),
    SPECIES_SPRITE(DUMPHILE, gMonBackPic_DUMPHILE),
    SPECIES_SPRITE(TOTEMI, gMonBackPic_TOTEMI),
    SPECIES_SPRITE(TOMETIC, gMonBackPic_TOMETIC),
    SPECIES_SPRITE(HOODLIN, gMonBackPic_HOODLIN),
    SPECIES_SPRITE(CHENBALLIN, gMonBackPic_CHENBALLIN),
    SPECIES_SPRITE(UNSHACKLIN, gMonBackPic_UNSHACKLIN),
    SPECIES_SPRITE(SLORMAG, gMonBackPic_SLORMAG),
    SPECIES_SPRITE(CLASDRON, gMonBackPic_CLASDRON),
    SPECIES_SPRITE(PLADYJACK, gMonBackPic_PLADYJACK),
