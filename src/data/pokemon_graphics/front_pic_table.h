const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CYBIO, gMonFrontPic_CYBIO),
    SPECIES_SPRITE(PROBIO, gMonFrontPic_PROBIO),
    SPECIES_SPRITE(DOMEBIO, gMonFrontPic_DOMEBIO),
    SPECIES_SPRITE(IGNION, gMonFrontPic_IGNION),
    SPECIES_SPRITE(IGNICORUS, gMonFrontPic_IGNICORUS),
    SPECIES_SPRITE(DRACOHOHO, gMonFrontPic_DRACOHOHO),
    SPECIES_SPRITE(JELLOSIS, gMonFrontPic_JELLOSIS),
    SPECIES_SPRITE(LUQUODI, gMonFrontPic_LUQUODI),
    SPECIES_SPRITE(CNIDAROLT, gMonFrontPic_CNIDAROLT),
    SPECIES_SPRITE(DRAGBY, gMonFrontPic_DRAGBY),
    SPECIES_SPRITE(DRAGAFRAUD, gMonFrontPic_DRAGAFRAUD),
    SPECIES_SPRITE(WISBUG, gMonFrontPic_WISBUG),
    SPECIES_SPRITE(SPOOCOON, gMonFrontPic_SPOOCOON),
    SPECIES_SPRITE(HORRIMOTH, gMonFrontPic_HORRIMOTH),
    SPECIES_SPRITE(GRAVEN, gMonFrontPic_GRAVEN),
    SPECIES_SPRITE(SHIRILL, gMonFrontPic_SHIRILL),
    SPECIES_SPRITE(GRIMIX, gMonFrontPic_GRIMIX),
    SPECIES_SPRITE(SORROGRIME, gMonFrontPic_SORROGRIME),
    SPECIES_SPRITE(KYOOTEDI, gMonFrontPic_KYOOTEDI),
    SPECIES_SPRITE(JILTEDI, gMonFrontPic_JILTEDI),
    SPECIES_SPRITE(JUNTRICK, gMonFrontPic_JUNTRICK),
    SPECIES_SPRITE(DUMPHILE, gMonFrontPic_DUMPHILE),
    SPECIES_SPRITE(TOTEMI, gMonFrontPic_TOTEMI),
    SPECIES_SPRITE(TOMETIC, gMonFrontPic_TOMETIC),
    SPECIES_SPRITE(HOODLIN, gMonFrontPic_HOODLIN),
    SPECIES_SPRITE(CHENBALLIN, gMonFrontPic_CHENBALLIN),
    SPECIES_SPRITE(UNSHACKLIN, gMonFrontPic_UNSHACKLIN),
    SPECIES_SPRITE(SLORMAG, gMonFrontPic_SLORMAG),
    SPECIES_SPRITE(CLASDRON, gMonFrontPic_CLASDRON),
    SPECIES_SPRITE(PLADYJACK, gMonFrontPic_PLADYJACK),
