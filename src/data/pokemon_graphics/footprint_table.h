...
{
    [SPECIES_NONE] = gMonFootprint_Empty,
    ...
    [SPECIES_CYBIO] = gMonFootprint_Cybio,
    [SPECIES_PROBIO] = gMonFootprint_Probio,
    [SPECIES_DOMEBIO] = gMonFootprint_Domebio,
    [SPECIES_IGNION] = gMonFootprint_Ignion,
    [SPECIES_IGNICORUS] = gMonFootprint_Ignicorus,
    [SPECIES_DRACOHOHO] = gMonFootprint_Dracohoho,
    [SPECIES_JELLOSIS] = gMonFootprint_Jellosis,
    [SPECIES_LUQUODI] = gMonFootprint_Luquodi,
    [SPECIES_CNIDAROLT] = gMonFootprint_Cnidarolt,
    [SPECIES_DRAGBY] = gMonFootprint_Dragby,
    [SPECIES_DRAGAFRAUD] = gMonFootprint_Dragafraud,
    [SPECIES_WISBUG] = gMonFootprint_Wisbug,
    [SPECIES_SPOOCOON] = gMonFootprint_Spoocoon,
    [SPECIES_HORRIMOTH] = gMonFootprint_Horrimoth,
    [SPECIES_GRAVEN] = gMonFootprint_Graven,
    [SPECIES_SHIRILL] = gMonFootprint_Shirill,
    [SPECIES_GRIMIX] = gMonFootprint_Grimix,
    [SPECIES_SORROGRIME] = gMonFootprint_Sorrogrime,
    [SPECIES_KYOOTEDI] = gMonFootprint_Kyootedi,
    [SPECIES_JILTEDI] = gMonFootprint_Jiltedi,
    [SPECIES_JUNTRICK] = gMonFootprint_Juntrick,
    [SPECIES_DUMPHILE] = gMonFootprint_Dumphile,
    [SPECIES_TOTEMI] = gMonFootprint_Totemi,
    [SPECIES_TOMETIC] = gMonFootprint_Tometic,
    [SPECIES_HOODLIN] = gMonFootprint_Hoodlin,
    [SPECIES_CHENBALLIN] = gMonFootprint_Chenballin,
    [SPECIES_UNSHACKLIN] = gMonFootprint_Unshacklin,
    [SPECIES_SLORMAG] = gMonFootprint_Slormag,
    [SPECIES_CLASDRON] = gMonFootprint_Clasdron,
    [SPECIES_PLADYJACK] = gMonFootprint_Pladyjack,
