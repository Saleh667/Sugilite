const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(CYBIO, gMonPalette_CYBIO),
    SPECIES_PAL(PROBIO, gMonPalette_PROBIO),
    SPECIES_PAL(DOMEBIO, gMonPalette_DOMEBIO),
    SPECIES_PAL(IGNION, gMonPalette_IGNION),
    SPECIES_PAL(IGNICORUS, gMonPalette_IGNICORUS),
    SPECIES_PAL(DRACOHOHO, gMonPalette_DRACOHOHO),
    SPECIES_PAL(JELLOSIS, gMonPalette_JELLOSIS),
    SPECIES_PAL(LUQUODI, gMonPalette_LUQUODI),
    SPECIES_PAL(CNIDAROLT, gMonPalette_CNIDAROLT),
    SPECIES_PAL(DRAGBY, gMonPalette_DRAGBY),
    SPECIES_PAL(DRAGAFRAUD, gMonPalette_DRAGAFRAUD),
    SPECIES_PAL(WISBUG, gMonPalette_WISBUG),
    SPECIES_PAL(SPOOCOON, gMonPalette_SPOOCOON),
    SPECIES_PAL(HORRIMOTH, gMonPalette_HORRIMOTH),
    SPECIES_PAL(GRAVEN, gMonPalette_GRAVEN),
    SPECIES_PAL(SHIRILL, gMonPalette_SHIRILL),
    SPECIES_PAL(GRIMIX, gMonPalette_GRIMIX),
    SPECIES_PAL(SORROGRIME, gMonPalette_SORROGRIME),
    SPECIES_PAL(KYOOTEDI, gMonPalette_KYOOTEDI),
    SPECIES_PAL(JILTEDI, gMonPalette_JILTEDI),
    SPECIES_PAL(JUNTRICK, gMonPalette_JUNTRICK),
    SPECIES_PAL(DUMPHILE, gMonPalette_DUMPHILE),
    SPECIES_PAL(TOTEMI, gMonPalette_TOTEMI),
    SPECIES_PAL(TOMETIC, gMonPalette_TOMETIC),
    SPECIES_PAL(HOODLIN, gMonPalette_HOODLIN),
    SPECIES_PAL(CHENBALLIN, gMonPalette_CHENBALLIN),
    SPECIES_PAL(UNSHACKLIN, gMonPalette_UNSHACKLIN),
    SPECIES_PAL(SLORMAG, gMonPalette_SLORMAG),
    SPECIES_PAL(CLASDRON, gMonPalette_CLASDRON),
    SPECIES_PAL(PLADYJACK, gMonPalette_PLADYJACK),
