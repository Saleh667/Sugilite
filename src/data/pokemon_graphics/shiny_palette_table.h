const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(CYBIO, gMonShinyPalette_CYBIO),
    SPECIES_SHINY_PAL(PROBIO, gMonShinyPalette_PROBIO),
    SPECIES_SHINY_PAL(DOMEBIO, gMonShinyPalette_DOMEBIO),
    SPECIES_SHINY_PAL(IGNION, gMonShinyPalette_IGNION),
    SPECIES_SHINY_PAL(IGNICORUS, gMonShinyPalette_IGNICORUS),
    SPECIES_SHINY_PAL(DRACOHOHO, gMonShinyPalette_DRACOHOHO),
    SPECIES_SHINY_PAL(JELLOSIS, gMonShinyPalette_JELLOSIS),
    SPECIES_SHINY_PAL(LUQUODI, gMonShinyPalette_LUQUODI),
    SPECIES_SHINY_PAL(CNIDAROLT, gMonShinyPalette_CNIDAROLT),
    SPECIES_SHINY_PAL(DRAGBY, gMonShinyPalette_DRAGBY),
    SPECIES_SHINY_PAL(DRAGAFRAUD, gMonShinyPalette_DRAGAFRAUD),
    SPECIES_SHINY_PAL(WISBUG, gMonShinyPalette_WISBUG),
    SPECIES_SHINY_PAL(SPOOCOON, gMonShinyPalette_SPOOCOON),
    SPECIES_SHINY_PAL(HORRIMOTH, gMonShinyPalette_HORRIMOTH),
    SPECIES_SHINY_PAL(GRAVEN, gMonShinyPalette_GRAVEN),
    SPECIES_SHINY_PAL(SHIRILL, gMonShinyPalette_SHIRILL),
    SPECIES_SHINY_PAL(GRIMIX, gMonShinyPalette_GRIMIX),
    SPECIES_SHINY_PAL(SORROGRIME, gMonShinyPalette_SORROGRIME),
    SPECIES_SHINY_PAL(KYOOTEDI, gMonShinyPalette_KYOOTEDI),
    SPECIES_SHINY_PAL(JILTEDI, gMonShinyPalette_JILTEDI),
    SPECIES_SHINY_PAL(JUNTRICK, gMonShinyPalette_JUNTRICK),
    SPECIES_SHINY_PAL(DUMPHILE, gMonShinyPalette_DUMPHILE),
    SPECIES_SHINY_PAL(TOTEMI, gMonShinyPalette_TOTEMI),
    SPECIES_SHINY_PAL(TOMETIC, gMonShinyPalette_TOMETIC),
    SPECIES_SHINY_PAL(HOODLIN, gMonShinyPalette_HOODLIN),
    SPECIES_SHINY_PAL(CHENBALLIN, gMonShinyPalette_CHENBALLIN),
    SPECIES_SHINY_PAL(UNSHACKLIN, gMonShinyPalette_UNSHACKLIN),
    SPECIES_SHINY_PAL(SLORMAG, gMonShinyPalette_SLORMAG),
    SPECIES_SHINY_PAL(CLASDRON, gMonShinyPalette_CLASDRON),
    SPECIES_SHINY_PAL(PLADYJACK, gMonShinyPalette_PLADYJACK),
