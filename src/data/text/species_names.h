const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CYBIO] =    _("Cybio"),
    [SPECIES_PROBIO] =    _("Probio"),
    [SPECIES_DOMEBIO] =    _("Domebio"),
    [SPECIES_IGNION] =    _("Ignion"),
    [SPECIES_IGNICORUS] =    _("Ignicorus"),
    [SPECIES_DRACOHOHO] =    _("Dracohoho"),
    [SPECIES_JELLOSIS] =    _("Jellosis"),
    [SPECIES_LUQUODI] =    _("Luquodi"),
    [SPECIES_CNIDAROLT] =    _("Cnidarolt"),
    [SPECIES_DRAGBY] =    _("Dragby"),
    [SPECIES_DRAGAFRAUD] =    _("Dragafraud"),
    [SPECIES_WISBUG] =    _("Wisbug"),
    [SPECIES_SPOOCOON] =    _("Spoocoon"),
    [SPECIES_HORRIMOTH] =    _("Horrimoth"),
    [SPECIES_GRAVEN] =    _("Graven"),
    [SPECIES_SHIRILL] =    _("Shirill"),
    [SPECIES_GRIMIX] =    _("Grimix"),
    [SPECIES_SORROGRIME] =    _("Sorrogrime"),
    [SPECIES_KYOOTEDI] =    _("Kyootedi"),
    [SPECIES_JILTEDI] =    _("Jiltedi"),
    [SPECIES_JUNTRICK] =    _("Juntrick"),
    [SPECIES_DUMPHILE] =    _("Dumphile"),
    [SPECIES_TOTEMI] =    _("Totemi"),
    [SPECIES_TOMETIC] =    _("Tometic"),
    [SPECIES_HOODLIN] =    _("Hoodlin"),
    [SPECIES_CHENBALLIN] =    _("Chenballin"),
    [SPECIES_UNSHACKLIN] =    _("Unshacklin"),
    [SPECIES_SLORMAG] =    _("Slormag"),
    [SPECIES_CLASDRON] =    _("Clasdron"),
    [SPECIES_PLADYJACK] =    _("Pladyjack"),
