...
//New Items
const u32 gItemIcon_ChestKey[] = INCBIN_U32("graphics/items/icons/key.4bpp.lz");
const u32 gItemIconPalette_ChestKey[] = INCBIN_U32("graphics/items/icon_palettes/key_item.gbapal.lz");