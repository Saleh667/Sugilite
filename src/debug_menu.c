...
#define DEBUG_NUMBER_DISPLAY_WIDTH_LARGE 20
#define DEBUG_NUMBER_DISPLAY_HEIGHT_LARGE 6
...
{
    .bg = 0,
    .tilemapLeft = 30 - DEBUG_NUMBER_DISPLAY_WIDTH_LARGE -1,
    .tilemapTop = 1,
    .width = DEBUG_NUMBER_DISPLAY_WIDTH_LARGE,
    .height = DEBUG_NUMBER_DISPLAY_HEIGHT_LARGE,
    .paletteNum = 15,
    .baseBlock = 1,
};
...
static void DebugAction_Give_PokemonSimple(u8 taskId)
{
    ...
    gTasks[taskId].data[2] = windowId;
    gTasks[taskId].data[3] = SPECIES_CYBIO;            //Current ID
    gTasks[taskId].data[4] = 0;            //Digit Selected
