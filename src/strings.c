...
const u8 gText_ThisIsAPokemon[] = _("Behold, this is a “Pokémon”.{PAUSE 96}\p");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd POKéMON EGG found by the DAY CARE\ncouple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar POKéMON EGG obtained at\nthe nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar POKéMON EGG obtained in\na trade.");
const u8 gText_EggFromHotSprings[] = _("A POKéMON EGG obtained at the\nhot springs.");
const u8 gText_EggFromTraveler[] = _("An odd POKéMON EGG obtained from\na traveler.");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the PHANTOS region.");
...
const u8 gText_HighlightLightRed[] = _("{HIGHLIGHT LIGHT_RED}");
...
const u8 gText_DexHoenn[] = _("PHANTOS");
...
const u8 gText_Hoenn[] = _("PHANTOS");
