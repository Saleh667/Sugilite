...
void WindowFunc_DrawDialogueFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 paletteNum)
{
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM),
                            tilemapLeft + width + 1,
                            tilemapTop - 1,
                            1,
                            1,
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 7),
                            tilemapLeft + width,
                            tilemapTop + 1,
                            1,
                            1,
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 6),
                            tilemapLeft + width + 1,
                            tilemapTop + 1,
                            1,
                            1,
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 9),
                            tilemapLeft + width,
                            tilemapTop + 2,
                            1,
                            1,
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 11),
                            tilemapLeft + width,
                            tilemapTop + 3,
                            1,
                            1,
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 10),
                            tilemapLeft + width + 1,
                            tilemapTop + 3,
                            1,
                            1,
    ...
    FillBgTilemapBufferRect(bg,
                            ...
                            DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,
                            BG_TILE_H_FLIP(DLG_WINDOW_BASE_TILE_NUM + 14),
                            tilemapLeft + width,
                            tilemapTop + 4,
                            1,
                            1,
